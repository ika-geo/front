...
import "../../../src/components/invoiceForm.css";
import "date-fns";
...
export default function EditInvoice() {
    ...
    async function fetchInvoiceData() {
        ...
        axios
            ...
            .then((response) => {
                ...
                let data = clientsInfo.data.filter(
    ...
    function handleEditInvoice() {
        ...
        console.log(2)
        axios
            .put(`${process.env.REACT_APP_API_URL}/invoice/${id}`, invoiceData, {
            ...
            .then(function () {
                ...
                const message = alert;
                message.message = "invoice changed successfully";
            ...
            .catch((error) => {
                if (error.response) {
                    const message = alert;
                    message.message = "invoice changed failed. " + error.response.data.status.message;
    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                {/*ika code*/}
                <div style={{display:'flex', justifyContent:'space-around', alignItems:'start', marginTop:'30px'}}>
